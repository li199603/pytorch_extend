...
if __name__ == "__main__":
    ...
    linear = torch.nn.Linear(in_features, out_features, dtype=dtype)
    ...
    label = torch.randn(batch_size, out_features, dtype=dtype)
    ...
    input_ = torch.randn(batch_size, in_features, requires_grad=True, dtype=dtype)
